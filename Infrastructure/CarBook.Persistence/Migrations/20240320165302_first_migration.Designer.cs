...
namespace CarBook.Persistence.Migrations
{
    ...
    [Migration("20240320165302_first_migration")]
            ...
            modelBuilder.Entity("CarBook.Domain.Entities.CarFeature", b =>
                {
                    b.HasOne("CarBook.Domain.Entities.Car", "Car")
                        .WithOne("CarFeatures")
                        .HasForeignKey("CarBook.Domain.Entities.CarFeature", "CarID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarBook.Domain.Entities.Feature", "Feature")
                        .WithOne("CarFeatures")
                        .HasForeignKey("CarBook.Domain.Entities.CarFeature", "FeatureID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CarBook.Domain.Entities.CarPricing", b =>
                {
                    b.HasOne("CarBook.Domain.Entities.Car", "Car")
                        .WithOne("CarPricings")
                        .HasForeignKey("CarBook.Domain.Entities.CarPricing", "CarID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarBook.Domain.Entities.Pricing", "Pricing")
                        .WithOne("CarPricings")
                        .HasForeignKey("CarBook.Domain.Entities.CarPricing", "PricingID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
